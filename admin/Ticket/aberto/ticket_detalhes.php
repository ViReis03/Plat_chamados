  ...
  <form method="POST" class="mt-3" onsubmit="return false">
    ...
    <div class="row">
      ...
      <div class="col-sm-8 text-end">
        <button class="btn btn-outline-success" onclick="deleteTicket()">Excluir Ticket</button>
        <button class="btn btn-outline-success" onclick="aguardandoTicket()">Definir Aguardando</button>
