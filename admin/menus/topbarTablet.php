...
<div class="row position-fixed w-100 tabnav" id="navMobile">
  ...
  <a href="?pag=usuarios" style="text-decoration: none;">
    <div class="tabnavBtn m-1" id="btoUsuarios">
  ...
  <a href="?pag=empresas" style="text-decoration: none;">
    <div class="tabnavBtn m-1" id="btoEmpresas">
      <svg xmlns="http://www.w3.org/2000/svg" width="25" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
