...
<div class="container">
  <form method="POST" class="mt-3" onsubmit="return false">
    ...
    <div class="row">
      ...
      <div class="col-lg-8 d-flex text-end mb-3">
    ...
    <div id="Informacoes">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <p>
            <select class="form-select" id="txtTipo" disabled>
        ...
        <div class="col-lg-4">
          ...
          <p><select class="form-select" name="txtEmpresa" id="txtEmpresa" onchange="usuario()" disabled>
              <?php
              include 'conexao.php';
        ...
        <div class="col-lg-4">
          ...
          <p><select class="form-select" name="txtUser" id="txtUser" disabled>
      ...
      <div class="row">
        <div class="col-lg-4 mt-2">
          ...
          <select class="form-select" aria-label="Default select example" id="txtCat1" onchange="categoria()" disabled>
        ...
        <div class="col-lg-4 mt-2">
          ...
          <select class="form-select" aria-label="Default select example" id="txtCat2" onchange="subcategoria()" disabled>
        ...
        <div class="col-lg-4 mt-2">
          ...
          <select class="form-select" aria-label="Default select example" id="txtCat3" disabled>
