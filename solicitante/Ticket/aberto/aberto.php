...
<div class="container">
    <div class="row">
            ...
            <tbody>
                ...
                try {
                    $data = $conn->query("
                                ...
                                where status_ticket != 4 and t.codigo_usuario = '$idUsuarioSessao'
                                ");
                    ...
                    foreach ($data as $ticket) {
                        ...
                        echo "<td>" . $ticket['nome_cat1']      . "</td>";
                        echo "<td>" . $ticket['nome_cat2']      . "</td>";
                        echo "<td>" . $ticket['nome_cat3']      . "</td>";
                        echo "<td>" . $ticket['codigo_usuario']      . "</td>";
        ...
        <script>
            ...
            function carregar() {
                setTimeout(() => {
                    window.location.assign("desktop.php?pag=ticket_aberto");
                }, 200);
            }
        </script>
    </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php include_once "Ticket/aberto/ticket_detalhes.php" ?>
            </div>
