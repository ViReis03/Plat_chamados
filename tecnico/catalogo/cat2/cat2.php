<div class="container text-center mt-3">
        <div class="row text-center mt-3">
            ...
            <div class="col-sm-5 d-flex flex-row-reverse bd-highlight h-25">
                <button type="button" class="btn btn-success d-flex flex-row-reverse" data-bs-toggle="modal" data-bs-target="#myModal" onclick="$('#btoLimpar').click()"> Gerenciador de SubCategorias </button>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    try {
                        ...
                        foreach ($data as $cat2) {
                            ...
                            echo "<td>" . $cat2['nome_cat1']    . "</td>";
                            echo "<td>" . $cat2['nome_cat2']      . "</td>";
                            echo "<td>" . $cat2['obs_cat2']      . "</td>";
                            echo "<td>" . $cat2['status_cat2']    . "</td>";
                            echo "</tr>";
                        }
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php include_once "catalogo/cat2/cat2_cadastro.php" ?>
                </div>
